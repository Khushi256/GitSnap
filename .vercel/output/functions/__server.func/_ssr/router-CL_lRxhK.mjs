...
const appCss = "/assets/styles-CRaEVnmF.css";
...
const $$splitComponentImporter$1 = () => import("../_username-6T88ZSCp.mjs");
const Route$1 = createFileRoute("/$username")({
  head: () => ({
    meta: [{
      title: "GitSnap"
    }, {
      name: "description",
      content: "Enter any GitHub username and explore a rich visual dashboard: contribution heatmap, languages, top repos, work-style breakdown, and more."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CVqtaD6d.mjs");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:description",
      content: "A visually rich dashboard of any GitHub user's activity — built with custom SVG charts."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const UsernameRoute = Route$1.update({
  id: "/$username",
  path: "/$username",
