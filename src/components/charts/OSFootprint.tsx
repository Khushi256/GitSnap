    ...
    <div className="flex h-full flex-col justify-center py-4">
      <div className="flex items-center justify-between mb-6">
        <div className="space-y-1">
          ...
          <div className="text-[10px] uppercase tracking-widest text-indigo-300 font-medium">Personal Repos</div>
        </div>
        <div className="text-right space-y-1">
          <div className="text-3xl font-display font-semibold text-white">{Math.round(externalPct * 100)}%</div>
          <div className="text-[10px] uppercase tracking-widest text-violet-300 font-medium">External / Comm.</div>
        </div>
      </div>
